# OOOSplat 0.46 相对原版项目的修改说明

本文用于说明当前本地升级版与上游 [ooolabdev/ooosplat](https://github.com/ooolabdev/ooosplat) 的主要差异。上游公开版本说明为 0.1.0，核心链路是“视频 → FFmpeg 抽帧 → COLMAP → Brush → final.ply”，并且不包含内置 3D Viewer；当前版本为本地升级版 0.46。
